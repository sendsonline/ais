...
<ul class="nav navbar-nav">
  ...
  <li><a href="#"> <i class="fa fa-gear"></i> Security <span
           class="caret"></a>
    <ul>
        ...
        while($row = mysqli_fetch_assoc($sql)){?>
                ...
                <?php }?>
                  ...
                  <center>
                    ...
                    <small><br> <?php echo $designation;?></small>
                  </center>
                  </font>
                  </p>
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="../process/logoutUser.php" class="btn btn-default btn-flat"><i class="glyphicon glyphicon-log-out"></i> Logout</a>
                   </div>
                </li>
              </ul>
            </li>
