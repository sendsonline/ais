           ...
           $year = $row['year_id'];
             ...
             while($row2 = mysqli_fetch_assoc($query2)){
              ...
              ?>
                        ...
                        <td style=" width:auto; font-size:16px;"> <?php echo $row2['student_no'];?></td>
                        <td style=" width:auto; font-size:16px;"> <?php echo $row2['fname'].' '.$row['lname'];?></td>
                        <td style=" width:auto; font-size:16px;"> <?php echo $row2['course'];?></td>
                        <td style=" width:auto; font-size:16px;"> <?php echo $row2['year'];?></td>
                        <?php
                        $q = mysqli_query($db,"SELECT * FROM winstudent WHERE cat_id = '$cat_id' AND stud_id = '$stud_id'");

                        if (mysqli_num_rows($q)>0) { ?>
                          <td><center><a href="#deleteModal<?php echo $row2['stud_id']?>" data-toggle="modal" data-target="#deleteModal<?php echo $row['stud_id'];?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-check" ></i> Remove from Winners Lists?</a></center></td>
