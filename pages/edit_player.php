      ...
      <section class="content">
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-gears"></i> Update players Info</h3>
          </div>
          <div class="box-body">
          <br><p></p>
          ...
          <p>Fields with (*) are required</p>
            ...
            <form class="form-horizontal" method="post" action="../process/updateprofileprocess.php">
                ...
                $query = mysqli_query($db,"SELECT players.*, course.*, sports.*, year.* from players LEFT JOIN course ON players.course_id = course.course_id LEFT JOIN sports ON players.sports_id = sports.sport_id LEFT JOIN year ON players.level_id = year.level_id WHERE players.stud_id = '$getid'") or die (mysql_error());
              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  while($row1 = mysqli_fetch_assoc($g)){
                      ...
                      <option value="<?php echo $row1['sport_id'];?>"><?php echo $row1['sports'];?></option>
                  <?php } ?>
                        </select>
                  </div>
                </div>
