...
?>
 ...
 $name = $_FILES['myfile']['name'];
        ...
        if(empty($student_no) || empty($lastname) || empty($firstname) || empty($middlename) || empty($course_id) || empty($gender) || empty($yearlevel) || empty($contact) || empty($address) || empty($avatar) || empty($birthdate) || empty($bloodtype) || empty($allergy) || empty($emergency) || empty($paddress) || empty($pcontact) || empty($status)){
           ...
           $exist = mysqli_query($db,"SELECT * FROM players WHERE student_no = '$student_no'");
            ...
            $sql =  mysqli_query($db,"INSERT INTO players VALUES(NULL,'$student_no','$lastname','$firstname','$middlename','$sports','$yearlevel','$course_id','$gender','$birthdate','$contact','$address','$bloodtype','$allergy','$emergency','$paddress','$pcontact','$status','$avatar','$student_no')");
            if($sql==true){
