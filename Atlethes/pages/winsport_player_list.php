              ...
              <thead>
                ...
                <tbody>
                  <?php include('../includes/connect.php');
                    ...
                    $query = mysqli_query($db,"SELECT players.*,course.*,year.*,sports.* FROM players LEFT JOIN course ON players.course_id = course.course_id LEFT JOIN year ON players.level_id = year.level_id LEFT JOIN sports ON players.sports_id = sports.sport_id") or die (mysql_error());
