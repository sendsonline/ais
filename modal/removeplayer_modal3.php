  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <h4>Are you sure you want to remove <strong style="color:red;"><?php echo $row['fname'].' '.$row['lname'];?></strong> from the winner(s) list?</h4>
      ...
      <div class="modal-footer">
        ...
        <a href="../process/removeprocess3.php?id=<?php echo $row['stud_id'];?>"  class="btn btn-success"><i class="glyphicon glyphicon-check"></i> Remove</a>
      </div>
